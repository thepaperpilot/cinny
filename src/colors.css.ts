...
export const nordTheme = createTheme(color, {
  Background: {
    Container: '#4C566A',
    ContainerHover: '#434C5E',
    ContainerActive: '#3B4252',
    ContainerLine: '#3B4252',
    OnContainer: '#ECEFF4',
  },
  ...
  Secondary: {
    ...
    OnMain: '#ECEFF4',
    Container: '#D8DEE9',
    ContainerHover: '#D8DEE9',
    ContainerActive: '#D8DEE9',
    ContainerLine: '#D8DEE9',
    OnContainer: '#2E3440',
  },
